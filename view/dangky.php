...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    extract($_POST);
    if (
        empty($ten_kh) || trim($ten_kh) == "" ||
        empty($sdt) || trim($sdt) == "" ||
        empty($dia_chi) || trim($dia_chi) == "" ||
        empty($email) || trim($email) == "" ||
        empty($mk) || trim($mk) == ""
    ) {
        $_SESSION['error'] = "Khum được để trống";
        header('location: '.BASE_URL.'dangky.php');
        die();
    } else {
        ...
        if (isset($_FILES['anh'])) {
            ...
            if ($file['size'] > 2042000) {
                $_SESSION['error']  = "Dung lượng ảnh quá lớn!";
                header('Location: '.BASE_URL.'dangky.php');
                die();
        ...
        $query = "INSERT INTO `khanh_hang`(`ten_kh`, `sdt`, `email`, `anh`, `dia_chi`, `mk`, `gioi_tinh`) 
        VALUES ('$ten_kh','$sdt','$email','$file_name','$dia_chi','$mk','$gioi_tinh')";
        open_close_sql($query);
                ...
                <div class="tab-content">
                        ...
                        <div class="auth-form__login">
                            ...
                            <div class="auth-form__sign-box">
                                <form action="" method="POST">
                                    ...
                                    <input type="text" id="mk" name="mk" class="search-input1">
                    ...
                    <div id="menu_2" class="tab-content-item">
                        <div class="auth-form__login">
                            ...
                            <h3 class="auth-text__content">ĐĂNG KÝ</h3>
                                ...
                                <form action="" method="POST" enctype="multipart/form-data">
                                    <div class="frm-sgn">
                                        <div class="sign-box__item">
                                            ...
                                            <input type="text" id="username" name="ten_kh" class="search-input">
                                            <!-- <br> -->
                                            <label for="sdt" class="sign-item">Số điện thoại *</label>
                                            <input type="text" id="sdt" name="sdt" class="search-input">
                                            <!-- <br> -->
                                            <label for="" class="sign-item">Ảnh đại diện *</label>
                                            <input type="file" name="anh" class="search-input3">
                                            <!-- <br> -->
                                        </div>
                                        <div class="sign-box__item-one">
                                            <label for="dia_chi" class="sign-item">Địa chỉ *</label>
                                            <input type="text" id="dia_chi" name="dia_chi" class="search-input-box">
                                            <!-- <br> -->
                                            <label for="email" class="sign-item">Email *</label>
                                            <input type="text" id="email" name="email" class="search-input-box">
                                            <!-- <br> -->
                                            <label for="mk" class="sign-item">Mật khẩu *</label>
                                            <input type="password" id="mk" name="mk" class="search-input-box">
                                            <!-- <br> -->
                                    ...
                                    <button class="onclick-btn1">ĐĂNG KÝ</button>
                                </form>
                            </div>
                        </div>
                    </div>
