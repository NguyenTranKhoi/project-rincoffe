...
<head>
    ...
    <link rel="stylesheet" href="./../css-product/italian-coffe.css">
                ...
                <div class="container_header">
                    ...
                    <nav>
                        <ul id="main-menu">
                            ...
                            <li>
                                <a href="">SẢN PHẨM
                                    <i class=" nav-down fas fa-caret-down"></i>
                                </a>
                                <ul class="sub-menu">
                                    <li><a href="">CÀ PHÊ VIỆT</a></li>
                                    <li><a href="">CÀ PHÊ Ý</a></li>
                                    <li><a href="">NƯỚC ÉP TRÀ</a></li>
            ...
            <article class="content-total-left">
                <div class="next_item_product">
                    <div class="next_item_content">
                        <div class="product_cafe_box">
                            <div class="three_image">
                                <img src="./../view/image/capuchino-25k-300x300.jpg" width="200px">
                            </div>
                            <div class="translate">
                    ...
                    <div class="next_item_content">
                        <div class="product_cafe_box">
                            <div class="three_image">
                                <img src="./../view/image/sp6.jpg" width="200px">
                            </div>
                            <div class="translate">
                                <button class="onclick">XEM CHI TIẾT</button>
                            </div>
                    ...
                    <div class="next_item_content">
                        <div class="product_cafe_box">
                            <div class="three_image">
                                <img src="./../view/image/sp5.jpg" width="200px">
                            </div>
                            <div class="translate">
                                <button class="onclick">XEM CHI TIẾT</button>
                            </div>
                    ...
                    <div class="next_item_content">
                        <div class="product_cafe_box">
                            <div class="cafe_item_image">
                                <img src="./../view/image/ESPRESSO-25k-300x300 (1).jpg" width="200px">
                            </div>
                            <div class="translate">
                                <button class="onclick">XEM CHI TIẾT</button>
                            </div>
                ...
                <div class="hihiaha">
                    <div class="next_item_content1">
                        <div class="product_cafe_box1">
                            <div class="cafe_item_image">
                                <img src="./../view/image/sp3.jpg" width="200px">
                            </div>
                    ...
                    <div class="next_item_content1">
                        <div class="product_cafe_box1">
                            <div class="cafe_item_image">
                                <img src="./../view/image/sp2.jpg" width="200px">
                            </div>
                            <div class="translate1">
                                <button class="onclick">XEM CHI TIẾT</button>
                            </div>
                    ...
                    <div class="next_item_content1">
                        <div class="product_cafe_box1">
                            <div class="cafe_item_image">
                                <img src="./../view/image/sp1.jpg" width="200px">
                            </div>
                            <div class="translate1">
                                <button class="onclick">XEM CHI TIẾT</button>
                            </div>
